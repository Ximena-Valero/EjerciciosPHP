<?php
	function createDB ($nameDB = "Usuarios", $pathDB = ""){
		try {
		    ...
		    $query = "CREATE TABLE 'Automoviles' (
						'idAutomoviles'	INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
						'Marca'	TEXT NOT NULL,
		    ...
		    $result = $db->exec($query); //Ejecutamos el query. Se usa exec para todos los casos excepto para los select.
		    echo ($result === false) ? "<i class='fa fa-times-circle'></i> No se pudo crear la Tabla Automoviles."."<br/>" : "<i class='fa fa-check-square-o'></i> Se creo correctamente la Tabla Automoviles."."<br/>";
